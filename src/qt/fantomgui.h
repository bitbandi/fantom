...
/**
  Fantom GUI main class. This class represents the main window of the Fantom UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FantomGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit FantomGUI(QWidget *parent = 0);
    ~FantomGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a fantom wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
   ...
   /// Get window identifier of QMainWindow (FantomGUI)
...
private:
    ...
    BuysPage *buysPage;
    SellsPage *sellsPage;
    BlanknodeManager *blanknodeManagerPage;
    ...
    QAction *fantomMarketAction;
    QAction *buysPageAction;
    QAction *sellsPageAction;
    QAction *blanknodeManagerAction;
...
private slots:
    ...
    /** Switch to FantomMarket Page*/
    void gotoFantomMarket();
    /** Switch to Buys Page*/
    void gotoBuysPage();
    /** Switch to Sells Page*/
    void gotoSellsPage();
    /** Switch to Blanknode Manager Page*/
    void gotoBlanknodeManagerPage();
